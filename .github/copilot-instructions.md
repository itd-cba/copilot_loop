...
- NEVER finish, end your turn or pause without calling the `copilot_loop` `ask_user` tool.
- Use the `copilot_loop` `ask_user` tool whenever you intend to end your turn and hand control back to the user.
